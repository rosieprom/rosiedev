...
import { storage, uuid, paramsParse, paramsRemove, inBrowser, parseReferrer, getBrowserLocale, getTimeZone } from 'analytics-utils';
    ...
    return function (next) {
      return function (action) {
        ...
        if (action.type === EVENTS.identify) {
          ...
          if (traits) {
            storage$$1.setItem(USER_TRAITS, _objectSpread$1({}, currentTraits, {}, traits));
          }
        }
      ...
      if (pipeline.processIndex && pipeline.processIndex.length) {
        pipeline.processIndex.forEach(function (i) {
          ...
          if (method && typeof method === 'function') {
            ...
            store.dispatch(_objectSpread$a({}, enrichedPayload, {
              type: pluginEvent,
...
function analytics() {
  ...
  combineReducers(_objectSpread$b({}, coreReducers, {}, customReducers)), // set user defined initial state
