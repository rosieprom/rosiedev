function SocialBar() {
    return (
      <div class="flex sm:flex-wrap justify-center">
            {/* Twitter */}
            <div class="w-1/9 md:pr-4">
                <a class="hover:bg-white" href="https://twitter.com/rosalie_dev" target="_blank">
                    <svg 
                        class="fill-current text-black hover:text-red-600 inline-block" 
            ...
            {/* Instagram */}
            <div class="w-1/9 md:pr-4">
                <a class="hover:bg-white" href="https://www.instagram.com/rosie.dev/" target="_blank">
                    <svg class="fill-current text-black hover:text-red-600 inline-block" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
            ...
            {/* Email */}
            <div class="w-1/9 md:pr-4">
                <a class="hover:bg-white" href="mailto:rosalinda.prom@gmail.com" target="_blank">
                    <svg class="fill-current text-black hover:text-red-600 inline-block" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
            ...
            {/* Github */}
            <div class="w-1/9 md:pr-4">
                <a class="hover:bg-white" href="https://github.com/developerpeachy" target="_blank">
                    <svg class="fill-current text-black hover:text-red-600 inline-block" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
            ...
            {/* Linkedin */}
            <div class="w-1/9 md:pr-4">
                <a class="hover:bg-white" href="https://www.linkedin.com/in/rosalinda-prom-15508a85/" target="_blank">
                    <svg class="fill-current text-black hover:text-red-600 inline-block" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
            ...
            {/* Telegram */}
            <div class="w-1/9 md:pr-4">
            <a class="hover:bg-white" href="https://t.me/rosalieprom" target="_blank">
                <svg class="fill-current text-black hover:text-red-600 inline-block" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
            ...
            {/* Spotify */}
            <div class="w-1/9 md:pr-4">
                <a class="hover:bg-white" href="https://open.spotify.com/user/1271090101?si=rRp14tFxSkqpXFEMeRScDg" target="_blank">
                    <svg class="fill-current text-black hover:text-red-600 inline-block" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
