  ...
  return (
    <Layout>
      <div className="flex justify-start pt-20">
        <h1 className="font-bold font-mono md:text-6xl text-4xl">
          About Rosalie
        </h1>
      </div>
      ...
      <div className="flex justify-start md:pt-8 pt-4">
        <p className="font-normal font-mono text-l">
      ...
      <div className="flex justify-start pt-8">
        <p className="font-normal font-mono text-x">
            I aspire to become a Full Stack Developer or a Solutions Architect with Blockchain experience.
            I'm passionate about current trends in technology, community and education. 
            I volunteer some of my spare time helping local communities thrive. 
        </p>
      </div>
      <div className="flex justify-start pt-8 pb-12">
              <div class="flex sm:flex-wrap justify-center">
                      {/* Resume  */}
                      <div class="w-2/9 px-2">
                          <a href="/static/RosalindaProm_CV.pdf" target="_blank" rel="noopener noreferrer">
                            <button class="bg-black hover:bg-purple-400 font-sans text-white font-bold py-2 px-4 rounded-full inline-flex items-center">
                      ...
                      <div class="w-1/9 px-2">
                          <button class="bg-white hover:bg-pink-400 font-bold py-2 px-2 rounded-full" href="https://twitter.com/rosalie_dev" target="_blank">
                      ...
                      {/* Instagram */}
                      <div class="w-1/9 px-2">
                          <button class="bg-white hover:bg-purple-400 text-white font-bold py-2 px-2 rounded-full" href="https://www.instagram.com/rosie.dev/" target="_blank">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                  <path d="M20.947,8.305c-0.011-0.757-0.151-1.508-0.419-2.216c-0.469-1.209-1.424-2.165-2.633-2.633 c-0.699-0.263-1.438-0.404-2.186-0.42C14.747,2.993,14.442,2.981,12,2.981s-2.755,0-3.71,0.055 c-0.747,0.016-1.486,0.157-2.185,0.42C4.896,3.924,3.94,4.88,3.472,6.089C3.209,6.788,3.067,7.527,3.053,8.274 c-0.043,0.963-0.056,1.268-0.056,3.71s0,2.754,0.056,3.71c0.015,0.748,0.156,1.486,0.419,2.187 c0.469,1.208,1.424,2.164,2.634,2.632c0.696,0.272,1.435,0.426,2.185,0.45c0.963,0.043,1.268,0.056,3.71,0.056s2.755,0,3.71-0.056 c0.747-0.015,1.486-0.156,2.186-0.419c1.209-0.469,2.164-1.425,2.633-2.633c0.263-0.7,0.404-1.438,0.419-2.187 c0.043-0.962,0.056-1.267,0.056-3.71C21.003,9.572,21.003,9.262,20.947,8.305z M11.994,16.602c-2.554,0-4.623-2.069-4.623-4.623 s2.069-4.623,4.623-4.623c2.552,0,4.623,2.069,4.623,4.623S14.546,16.602,11.994,16.602z M16.801,8.263 c-0.597,0-1.078-0.482-1.078-1.078s0.481-1.078,1.078-1.078c0.595,0,1.077,0.482,1.077,1.078S17.396,8.263,16.801,8.263z"/><circle cx="11.994" cy="11.979" r="3.003"/>
                              </svg>
                          </button>
                      </div>
                      {/* Email */}
                      <div class="w-1/9 px-2">
                          <button class="bg-white hover:bg-blue-400 text-white font-bold py-2 px-2 rounded-full" href="mailto:rosalinda.prom@gmail.com" target="_blank">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                      ...
                      {/* Github */}
                      <div class="w-1/9 px-2">
                          <button class="bg-white hover:bg-teal-400 text-white font-bold py-2 px-2 rounded-full" href="https://github.com/developerpeachy" target="_blank">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                      ...
                      {/* Linkedin */}
                      <div class="w-1/9 px-2">
                          <button class="bg-white hover:bg-green-400 text-white font-bold py-2 px-2 rounded-full" href="https://www.linkedin.com/in/rosalinda-prom-15508a85/" target="_blank">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                      ...
                      {/* Telegram */}
                      <div class="w-1/9 px-2">
                      <button class="bg-white hover:bg-yellow-400 text-white font-bold py-2 px-2 rounded-full" href="https://t.me/rosalieprom" target="_blank">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                      ...
                      {/* Spotify */}
                      <div class="w-1/9 px-2">
                          <button class="bg-white hover:bg-red-400 text-white font-bold py-2 px-2 rounded-full" href="https://open.spotify.com/user/1271090101?si=rRp14tFxSkqpXFEMeRScDg" target="_blank">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
